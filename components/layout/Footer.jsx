...
export default function Footer() {
  return (
    <footer id="contact" className="bg-obsidian-950 border-t border-white/6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3 mb-6 group">
              ...
              <span className="font-display font-bold text-xl tracking-widest text-white uppercase">VELOX</span>
            </Link>
            <p className="text-platinum-500 text-sm leading-relaxed font-body mb-6">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 flex items-center justify-center rounded-lg bg-graphite-600 text-platinum-400 hover:bg-gold/15 hover:text-gold transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {/* Fleet */}
          <div>
            <h3 className="font-display font-semibold text-white text-sm tracking-widest uppercase mb-5">
              Fleet
            </h3>
            <ul className="space-y-3">
              {fleetLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-sm font-body text-platinum-500 hover:text-gold transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm font-body text-platinum-500">14 Mayfair Crescent, London W1K 5NF</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+442079460000" className="text-sm font-body text-platinum-500 hover:text-gold transition-colors">+44 20 7946 0000</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:hello@veloxrentals.com" className="text-sm font-body text-platinum-500 hover:text-gold transition-colors">hello@veloxrentals.com</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-sm font-body text-platinum-500">Mon–Sun, 07:00–22:00</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="py-6 border-t border-white/6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs font-body text-platinum-500">
            © {new Date().getFullYear()} Velox Rentals Ltd. All rights reserved.
          </p>
          <div className="flex items-center gap-2">
            <span className="text-xs font-body text-platinum-500">Accepted payments:</span>
            {["VISA", "MC", "AMEX", "PayPal"].map((p) => (
              <span key={p} className="px-2 py-1 bg-graphite-600 rounded text-2xs font-mono text-platinum-400">{p}</span>
            ))}
          </div>
        </div>
      </div>
