    ...
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050505] py-20">
      ...
      <div className="relative z-10 w-full max-w-[1000px] mx-auto px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-12">
            ...
            <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 p-12 rounded-[28px] flex flex-col items-center text-center gap-5 min-h-[260px] justify-center transition-all duration-500 hover:border-[#c9a84c]/30 hover:bg-white/[0.04]">
              ...
              <p className="text-white/70 text-[14px] font-normal font-body leading-relaxed max-w-[240px] tracking-wide">
                Every rental includes Comprehensive Collision Damage Waiver (CDW) and Theft Protection as standard.
              </p>
            </div>

            {/* Card 2: Deductibles */}
            <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 p-12 rounded-[28px] flex flex-col items-center text-center gap-5 min-h-[260px] justify-center transition-all duration-500 hover:border-[#c9a84c]/30 hover:bg-white/[0.04]">
              <div className="text-[#c9a84c] text-2xl font-bold font-display tracking-tight">02. Deductibles</div>
              <p className="text-white/70 text-[14px] font-normal font-body leading-relaxed max-w-[240px] tracking-wide">
                Standard excess ranges from £1,500 to £3,000. Reduce this to £0 with our Premium Protection package.
              </p>
            </div>

            {/* Card 3: Claim Process */}
            <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 p-12 rounded-[28px] flex flex-col items-center text-center gap-5 min-h-[260px] justify-center transition-all duration-500 hover:border-[#c9a84c]/30 hover:bg-white/[0.04]">
              <div className="text-[#c9a84c] text-2xl font-bold font-display tracking-tight">03. Claims</div>
              <p className="text-white/70 text-[14px] font-normal font-body leading-relaxed max-w-[240px] tracking-wide">
                Contact our 24/7 concierge. Document the scene and fill out the digital claim form within 24 hours.
              </p>
            </div>
          ...
          {/* Back to Home Button — Luxury Pill */}
          <Link
            href="/"
